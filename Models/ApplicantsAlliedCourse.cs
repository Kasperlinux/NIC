...
[Table("Applicants_AlliedCourses")]
public partial class ApplicantsAlliedCourse
{
    [Key]
    [Column("Applicant_Id")]
    ...
    [Column("marks_Mathematics_Theory")]
    public double? MarksMathematicsTheory { get; set; }

    [Column("marks_Mathematics_Practical")]
    public double? MarksMathematicsPractical { get; set; }

    [Column("fullmarks_Mathematics")]
